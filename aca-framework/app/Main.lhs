...
configuration = Configuration
  ...
  <*> strOption
      ...
      <> metavar "FILTER"
      <> value "all"
      <> help "(all | allDock | cpaSeq | uAutomizer | veriAbs | pesco | symbiotic | esbmc | twoLs | cbmc | uTaipan | uKojak | pinaka | cpaBamSmg | cpaBamBnB | cvtAlgoSel | cvtParPort | goblint | graves | lart | smack | theta | veriFuzz | (comma-sep. string of tools))")
  <*> option auto
