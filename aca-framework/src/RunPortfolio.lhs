...
aContainerName (Analyzer Graves _ _ _ _ _ _ _ _) = error "oops: i have not integrated 'Graves' into alpaca"
aContainerName (Analyzer Infer _ _ _ _ _ _ _ _) = "infer"
aContainerName (Analyzer Pesco _ _ _ _ _ _ _ _) = "pesco"
aContainerName (Analyzer Pinaka _ _ _ _ _ _ _ _) = "pinaka"
aContainerName (Analyzer SMACK _ _ _ _ _ _ _ _) = error "oops: i have not integrated 'Smack' into alpaca"
