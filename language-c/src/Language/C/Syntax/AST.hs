...
data CTranslationUnit a
  = CTranslUnit [CExternalDeclaration a] a
    deriving (Eq, Show, Data, Typeable, Generic, Generic1 {-! ,CNode ,Functor, Annotated !-})
...
data CDeclaration a
  = CDecl
    ...
    | CStaticAssert
      ...
      a                       -- annotation
    deriving (Eq, Show, Data,Typeable, Generic {-! ,CNode ,Annotated !-})
...
data CPartDesignator a
  ...
  | CRangeDesig (CExpression a) (CExpression a) a
    deriving (Eq, Show, Data,Typeable, Generic {-! ,CNode ,Functor ,Annotated !-})
...
data CExpression a
  ...
  | CBuiltinExpr (CBuiltinThing a)       -- ^ builtin expressions, see 'CBuiltin'
    deriving (Eq, Data,Typeable,Show, Generic {-! ,CNode , Annotated !-})
